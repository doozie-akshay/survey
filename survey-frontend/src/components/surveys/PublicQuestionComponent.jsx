      ...
      <div>
        ...
        {question.type === 'radio' && (
          <div className='my-2'>
            {question.data.options.map((option, index) => (
              <div key={option.uuid}>
                <input id={option.uuid} name={'question-' + question.id} type='radio' value={option.uuid} className='mr-2'
        ...
        {question.type === 'checkbox' && (
          <div className='my-2'>
            {question.data.options.map((option, index) => (
              <div key={option.uuid}>
                <input id={option.uuid} name={'question-' + question.id} type='checkbox' value={option.uuid}
                       className='mr-2'
